...
.config(function ($stateProvider, $urlRouterProvider, $httpProvider) {
    ...
    $stateProvider
        ...
        .state('account.accountList', {
            url: '/accountList',
            templateUrl: 'views/acount/account.html',
            //controller: "accountCtrl",
            controllerAs: "account",
            resolve: {
                deps: ["$ocLazyLoad", function ($ocLazyLoad) {
                    return $ocLazyLoad.load(["js/services/accountServices.js",
                        "js/controllers/accountControllers.js",
                        "js/angular-file-upload.js",
                        "js/controllers/UploadFile.js"]);
                }]
            }
        })
        //.state("default", {
