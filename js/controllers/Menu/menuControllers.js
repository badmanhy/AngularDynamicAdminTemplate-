BadManAdmin
 .controller('menuController', function ($http, $filter, $scope, ngTableParams, menuService) {
     ...
     $scope.actions = {
         ...
         clicks: function (list, btn) {
             var btnCase = btn.action;
             if (btnCase == undefined)
                 btnCase = btn
             ...
             switch (btnCase) {
                 ...
                 case "view":
                     ...
                     break
                 case "create":
                     $scope.createdMenu($scope.menuView, serviceBase + "CreateMenu")
                     break
             }
         }
     };

     $scope.createdMenu = function (menuView, apiAction) {
         debugger;
         menuService.createdMenu(menuView, apiAction).then(function (response) {
